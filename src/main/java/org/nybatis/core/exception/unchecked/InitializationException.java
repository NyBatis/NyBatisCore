...
public class InitializationException extends BaseRuntimeException {
     ...
     */
    public InitializationException( String message, Object... messageParam ) {
     ...
     * @param messageParam '@' 문자를 치환할 파라미터
     */
    public InitializationException( Throwable rootCause, String message, Object... messageParam ) {
