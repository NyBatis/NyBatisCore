...
public class LessThanNode extends EqualityNode {
	...
	@Override
  	public BooleanValueNode calculate( Node pre, Node post ) throws SqlParseException {
		...
		switch( getBitFlag( pre, post ) ) {
			case 0x11 :
			case 0x12 :
				return new BooleanValueNode( pre.toNumericValueNode().isLessThan( post ) );
			case 0x21 :
			case 0x22 :
				return new BooleanValueNode( pre.toStringValueNode().isLessThan( post ) );
			case 0x10 :
			case 0x20 :
